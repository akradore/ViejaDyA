...
class inventory_wizard(models.TransientModel):
    ...
    date_from = fields.Date('Date', required="1", default=fields.Datetime.now)
    ...
    product_ids = fields.Many2many('product.template', string='Product', domain=[('type','=','product')])
...
#        
    ...
    def print_pdf(self):
        ...
        return self.env.ref('dev_inventory_ageing_report.print_dev_stock_inventory_ageing_report').report_action(self, data=datas)

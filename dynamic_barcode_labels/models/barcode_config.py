...
class BarcodeConfiguration(models.Model):
    ...
    delivery_address = fields.Boolean('Print Delivery Address')
    lot = fields.Boolean('Production Lot')
    text_1 = fields.Text('Text 1')
    text_2 = fields.Text('Text 2')

    image = fields.Boolean('Product Logo/Image', default=True)
    image_width = fields.Integer('Logo Width(px)', default=50)
    image_height = fields.Integer('Logo Height(px)', default=20)
    ...
    delivery_address_size = fields.Char('Address Font Size', default=5)
    text_1_size = fields.Char('Text1 Font Size', default=5)
    text_2_size = fields.Char('Text2 Font Size', default=5)
